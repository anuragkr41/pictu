package com.pictu.customerService.externalServices;
...
public interface PhotoService {
    ...
    @GetMapping("/photos/customer/{customerId}")
    List<Photo> getPhotosByCustomerId(@PathVariable String customerId);
